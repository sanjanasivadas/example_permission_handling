...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    void requestCameraPermission() async {
      //status can neither be: granted, denied, restricted or permanentlyDenied
...
void requestMultiplePermissions() async{
  ...
  print("location permission:${statuses[Permission.location]},""storage permission: ${statuses[Permission.storage]}");
}
